...
type UpgradeAPI interface {
	GetTargetedNodes(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig) ([]v1.Node, error)
	GetUpgradedNode(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, nodes []v1.Node) *v1.Node
	UncordonUpgradedNode(ctx context.Context, node *v1.Node) error
	GetNodeForUpgrade(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, nodes []v1.Node) *v1.Node
	CordonNodeForUpgrade(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, node *v1.Node) error
	KickoffUpgrade(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, node *v1.Node) error
	RemoveUpgradeLabels(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig) error
}
...
func (ui *upgradeImpl) GetTargetedNodes(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig) ([]v1.Node, error) {
...
func (ui *upgradeImpl) GetUpgradedNode(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, nodes []v1.Node) *v1.Node {
...
func (ui *upgradeImpl) GetNodeForUpgrade(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, nodes []v1.Node) *v1.Node {
...
func (ui *upgradeImpl) CordonNodeForUpgrade(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, node *v1.Node) error {
	if node == nil {
		return nil
	}
...
func (ui *upgradeImpl) KickoffUpgrade(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig, node *v1.Node) error {
	if node == nil {
		return nil
	}
...
func (ui *upgradeImpl) RemoveUpgradeLabels(ctx context.Context, devConfig *intelv1alpha1.DeviceConfig) error {
...
func isNewNodeForUpgrade(node *v1.Node, devConfig *intelv1alpha1.DeviceConfig) bool {
	nodeLabels := node.GetLabels()
